    ...
    var body: some View {
        ...
        VStack {
            ...
            VStack(alignment: .leading,spacing: 12) {
                Text("recent courses".uppercased())
                    .font(.body).fontWeight(.semibold).foregroundStyle(.linearGradient(colors: [.secondary, .primary.opacity(0.3)],startPoint: .topLeading, endPoint: .bottomTrailing)).lineLimit(1)
